...
class FacebookObfuscationDetector(ObfuscationDetector):
    def is_class_name_obfuscated(self, class_name_prefix: str) -> bool:
    ...
    def is_package_name_obfuscated(self, package_name_prefix: str) -> bool:
...
def test_facebook_apk():
    ...
    apk_differ = ApkDiffer(FacebookObfuscationDetector(), [android_class_filter])
